...
static def SelectDzo1() {
    ...
    WebUI.scrollToElement(findTestObject('Показатели баланса(2006-2021)/Россети Янтарь'), 30)

    WebUI.scrollToElement(findTestObject('Показатели баланса(2006-2021)/скролл'), 30)

    WebUI.click(findTestObject('Показатели баланса(2006-2021)/выбрать Россети Центр и Приволжье(ГК)'))
...
static def SelectDzo2() {
    ...
    WebUI.scrollToElement(findTestObject('Показатели баланса(2006-2021)/выбрать Россети Центр и Приволжье(ГК)'), 30)

    WebUI.scrollToElement(findTestObject('Показатели баланса электроэнергии 2006-2021 блок БАЛАНАСЫ/scroll'), 30)

    WebUI.click(findTestObject('Показатели баланса электроэнергии 2006-2021 блок БАЛАНАСЫ/выбрать Россети Центр и Приволжье'))
