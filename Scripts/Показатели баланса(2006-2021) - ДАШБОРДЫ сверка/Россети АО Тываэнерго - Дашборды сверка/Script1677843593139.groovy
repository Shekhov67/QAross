...
static def SelectDzo1() {
    ...
    WebUI.click(findTestObject('Показатели баланса(2006-2021)/АО Тываэнерго'))
...
static def SelectDzo2() {
    ...
    WebUI.click(findTestObject('Показатели баланса электроэнергии 2006-2021 блок БАЛАНАСЫ/АО Тываэнерго'))
