...
def Test(def run, def todaysDate, def widget) {
    ...
    WebUI.scrollToElement(findTestObject('Прогноз по ДЗО стресс сценарий/выбрать Россети Волга'), 30)

    WebUI.scrollToElement(findTestObject('Прогноз по ДЗО стресс сценарий/скролл'), 30)

    WebUI.click(findTestObject('Прогноз по ДЗО стресс сценарий/выбрать Россети Волга'))
