...
WebUI.click(findTestObject('Прогноз по ДЗО/Магистральные сети'))

WebUI.click(findTestObject('Прогноз по ДЗО/Россети ФСК ЕЭС'))

WebUI.click(findTestObject('Прогноз по ДЗО/выбрать Итого по ФСК ЕЭС'))
