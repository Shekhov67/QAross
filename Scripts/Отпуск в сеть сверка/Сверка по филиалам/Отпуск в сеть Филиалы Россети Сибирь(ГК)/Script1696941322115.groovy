...
otpuskVSeti = findTestData('Test Data').getValue(2, 40)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 41)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 42)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 43)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 44)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 45)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 46)
