...
static def SelectDzo1() {
    ...
    WebUI.click(findTestObject('Показатели баланса(2006-2021)/выбрать Россети Янтарь'))
...
static def SelectDzo2() {
    ...
    WebUI.click(findTestObject('Показатели баланса электроэнергии 2006-2021 блок БАЛАНАСЫ/выбрать Россети Янтарь'))
