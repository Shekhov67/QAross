...
obemPoter = findTestData('Test Data').getValue(3, 62)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 62)
...
obemPoter = findTestData('Test Data').getValue(3, 61)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 61)
...
obemPoter = findTestData('Test Data').getValue(3, 57)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 57)
...
obemPoter = findTestData('Test Data').getValue(3, 58)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 58)
...
obemPoter = findTestData('Test Data').getValue(3, 59)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 59)
...
obemPoter = findTestData('Test Data').getValue(3, 60)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 60)
