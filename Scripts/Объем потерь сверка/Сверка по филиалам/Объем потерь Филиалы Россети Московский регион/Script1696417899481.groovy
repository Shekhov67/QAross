...
obemPoter = findTestData('Test Data').getValue(3, 65)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 65)
...
obemPoter = findTestData('Test Data').getValue(3, 64)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 64)
