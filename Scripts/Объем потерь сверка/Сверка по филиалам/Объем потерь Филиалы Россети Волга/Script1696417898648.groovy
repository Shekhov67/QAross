...
obemPoter = findTestData('Test Data').getValue(3, 24)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 24)
...
obemPoter = findTestData('Test Data').getValue(3, 25)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 25)
...
obemPoter = findTestData('Test Data').getValue(3, 26)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 26)
...
obemPoter = findTestData('Test Data').getValue(3, 27)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 27)
...
obemPoter = findTestData('Test Data').getValue(3, 28)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 28)
...
obemPoter = findTestData('Test Data').getValue(3, 29)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 29)
...
obemPoter = findTestData('Test Data').getValue(3, 30)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 30)
