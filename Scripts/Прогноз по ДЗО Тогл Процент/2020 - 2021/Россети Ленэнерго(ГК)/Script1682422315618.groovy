...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Россети Ленэнерго(ГК)'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/выбрать Россети Ленэнерго(ГК)'))
...
WebUI.click(findTestObject('Прогноз по ДЗО/Россети Ленэнерго(ГК)'))

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Ленинградская область'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Ленинградская область'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Санкт-Петербург'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Санкт-Петербург'))
