...
def Test(def run, def todaysDate, def widget) {
    ...
    WebUI.click(findTestObject('Прогноз по ДЗО/выбрать АО Чеченэнерго'))
    ...
    WebUI.scrollToElement(findTestObject('Прогноз по ДЗО стресс сценарий/выбрать АО Чеченэнерго'), 30)

    WebUI.scrollToElement(findTestObject('Прогноз по ДЗО стресс сценарий/скролл'), 30)

    WebUI.click(findTestObject('Прогноз по ДЗО стресс сценарий/выбрать АО Чеченэнерго'))
