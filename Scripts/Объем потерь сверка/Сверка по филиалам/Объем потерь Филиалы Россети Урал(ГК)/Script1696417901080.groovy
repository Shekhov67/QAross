...
obemPoter = findTestData('Test Data').getValue(3, 48)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 48)
...
obemPoter = findTestData('Test Data').getValue(3, 49)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 49)
...
obemPoter = findTestData('Test Data').getValue(3, 50)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 50)
