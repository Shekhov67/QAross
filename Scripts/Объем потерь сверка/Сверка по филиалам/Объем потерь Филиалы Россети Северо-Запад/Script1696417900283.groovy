...
obemPoter = findTestData('Test Data').getValue(3, 32)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 32)
...
obemPoter = findTestData('Test Data').getValue(3, 33)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 33)
...
obemPoter = findTestData('Test Data').getValue(3, 34)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 34)
...
obemPoter = findTestData('Test Data').getValue(3, 35)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 35)
...
obemPoter = findTestData('Test Data').getValue(3, 37)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 37)
...
obemPoter = findTestData('Test Data').getValue(3, 38)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 38)
...
obemPoter = findTestData('Test Data').getValue(3, 36)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 36)
