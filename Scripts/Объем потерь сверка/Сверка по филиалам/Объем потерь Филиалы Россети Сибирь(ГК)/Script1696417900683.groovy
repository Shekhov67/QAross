...
obemPoter = findTestData('Test Data').getValue(3, 40)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 40)
...
obemPoter = findTestData('Test Data').getValue(3, 41)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 41)
...
obemPoter = findTestData('Test Data').getValue(3, 42)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 42)
...
obemPoter = findTestData('Test Data').getValue(3, 43)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 43)
...
obemPoter = findTestData('Test Data').getValue(3, 44)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 44)
...
obemPoter = findTestData('Test Data').getValue(3, 45)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 45)
...
obemPoter = findTestData('Test Data').getValue(3, 46)

println(obemPoter)

percentPoter = findTestData('Test Data').getValue(4, 46)
