...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Россети Центр'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/выбрать Россети Центр'))
...
WebUI.click(findTestObject('Прогноз по ДЗО/Россети Центр'))

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Белгородэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Белгородэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Брянскэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Брянскэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Воронежэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Воронежэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Костромаэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Костромаэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Курскэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Курскэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Липецкэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Липецкэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Орелэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Орелэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Смоленскэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Смоленскэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Тамбовэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Тамбовэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Тверьэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Тверьэнерго'))
...
static def SelectDate() {
    ...
    WebUI.click(findTestObject('Прогноз по ДЗО/выбрать 2020'))

    def selectMouth = SelectMouth()

    WebUI.click(findTestObject('Прогноз по ДЗО/фильтр Год'))

    WebUI.click(findTestObject('Прогноз по ДЗО/выбрать 2021'))
