...
WebUI.scrollToElement(findTestObject('КПО/Россети Янтарь(верхний уровень)'), 30)

WebUI.scrollToElement(findTestObject('КПО/скролл Фильтр дата'), 30)

WebUI.click(findTestObject('КПО/выбрать Россети Янтарь'))
...
WebUI.click(findTestObject('КПО для раздела Выручка/выбрать Россети Янтарь'))
