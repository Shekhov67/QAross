...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Россети Урал(ГК)'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/выбрать Россети Урал(ГК)'))
...
WebUI.click(findTestObject('Прогноз по ДЗО/Россети Урал(ГК)'))

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Пермэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Пермэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Свердловэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Свердловэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Челябэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Челябэнерго'))
