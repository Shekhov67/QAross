...
otpuskVSeti = findTestData('Test Data').getValue(2, 32)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 33)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 34)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 35)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 36)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 37)
...
otpuskVSeti = findTestData('Test Data').getValue(2, 38)
