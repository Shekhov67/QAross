...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Россети Кубань'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/выбрать Россети Кубань'))
...
WebUI.click(findTestObject('Прогноз по ДЗО/Россети Кубань'))

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Кубаньэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Кубаньэнерго'))
