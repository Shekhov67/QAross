...
WebUI.click(findTestObject('Прогноз по ДЗО/выбрать Россети Центр и Приволжье(ГК)'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/АО Свет'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/АО Свет'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Владимирэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Владимирэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Ивэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Ивэнерго'))
...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Калугаэнерго'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Калугаэнерго'))
