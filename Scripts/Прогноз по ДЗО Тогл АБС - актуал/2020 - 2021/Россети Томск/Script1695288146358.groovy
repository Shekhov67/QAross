...
WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Россети Томск'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/выбрать Россети Томск'))
...
WebUI.click(findTestObject('Прогноз по ДЗО/Россети Томск'))

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/Томская распредлелительная компания'), 30)

WebUI.scrollToElement(findTestObject('Прогноз по ДЗО/скролл'), 30)

WebUI.click(findTestObject('Прогноз по ДЗО/Томская распредлелительная компания'))
